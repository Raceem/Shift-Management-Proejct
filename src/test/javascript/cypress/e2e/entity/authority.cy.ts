...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'd3165479-123d-4871-bf19-78aebf20a903' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('83415ed9-ef67-4f51-a468-c6046c081e36');
      cy.get(`[data-cy="name"]`).should('have.value', '83415ed9-ef67-4f51-a468-c6046c081e36');
